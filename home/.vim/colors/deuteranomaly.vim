...
let g:colors_name="deuteranomaly"
...
hi IncSearch term=reverse cterm=NONE ctermbg=3 ctermfg=0
hi Search term=reverse cterm=NONE ctermbg=3 ctermfg=0
...
"7 - grey
"8 - dark grey
hi StatusLine term=reverse cterm=NONE ctermbg=0 ctermfg=7
hi StatusLineNC term=reverse cterm=NONE ctermbg=0 ctermfg=8
hi VertSplit term=reverse cterm=NONE ctermbg=0 ctermfg=0
...
hi ColorColumn term=reverse cterm=NONE ctermbg=8
...
hi LineNr ctermbg=bg ctermfg=8
hi Comment ctermbg=bg ctermfg=8
"8
"comment here
